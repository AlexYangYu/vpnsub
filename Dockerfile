...
ARG MIHOMO_AMD64_SHA256=a048ecbe2dc598321f63a6fbeffa93f0c10ca6db818f64b2b83cf19ef194d73f
...
RUN apt-get update \
    ...
    && case "${MIHOMO_ARCH}" in \
         amd64) MIHOMO_ASSET_ARCH="amd64-v1"; MIHOMO_SHA256="${MIHOMO_AMD64_SHA256}" ;; \
         arm64) MIHOMO_ASSET_ARCH="arm64"; MIHOMO_SHA256="${MIHOMO_ARM64_SHA256}" ;; \
         *) echo "Unsupported architecture: ${MIHOMO_ARCH}" >&2; exit 1 ;; \
       esac \
    && curl --fail --show-error --location --retry 3 \
         --output /tmp/mihomo.gz \
         "https://github.com/MetaCubeX/mihomo/releases/download/${MIHOMO_VERSION}/mihomo-linux-${MIHOMO_ASSET_ARCH}-${MIHOMO_VERSION}.gz" \
